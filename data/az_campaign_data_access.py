...
party = pd.read_csv("AZ_PoliticalParties_04_23.csv", 
                    encoding='utf-16le').reset_index().drop(["CashBalance"], axis=1).rename(
  columns = {"Expense": "CashBalance", "Income": "Expense", "Name": "Income", "index": "Name"})
