...
def add_unique_lastname_column(df_with_names:pd.DataFrame, lastname_col:str) -> pd.DataFrame:
    ...
    df_with_names["is_unique_lastname"] = df_with_names[lastname_col].map(lastname_counts) == 1
