...
class PennsylvaniaTransformer(clean.StateTransformer):
    ...
    directory = BASE_FILEPATH / "data" / "raw" / "PA" / "2022"

    def __init__(self):
        self.contributionFrom = Form.PennsylvaniaContributionFormPost2022()
    ...
    def clean_state(
        ...
        contribs_files = [
            f for f in directory.iterdir() if f.name.startswith("contrib")
        ]
